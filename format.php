...
/* <![CDATA[ */
    @import url(<?php echo $CFG->wwwroot ?>/course/format/topmas/topmas.css);
/* ]]> */
</style>
<?php
$PAGE->requires->js('/course/format/topmas/js/jquery-1.6.4.min.js');
$PAGE->requires->js('/course/format/topmas/js/jquery.masonry.min.js');
$PAGE->requires->js('/course/format/topmas/js/masonry.js');
...
$section = 1;
$sectionmenu = array();
echo "</ul><ul id='masonry' class='topics'>\n";
while ($section <= $course->numsections) {
    ...
    if ($showsection) {
        ...
        echo '<li id="section-'.$section.'" class="item section main clearfix'.$sectionstyle.'" >'; //'<div class="left side">&nbsp;</div>';
